...
var blockRange = document.querySelector('.blockRange');
...
var track: any = document.querySelector('.track');
track.style.width = inputsRy.theValue[1] * rangeK - inputsRy.theValue[0] * rangeK + 'px';

var thumbs: any = document.querySelectorAll('.thumb');
...
var outputs: any = document.querySelectorAll('.output');
